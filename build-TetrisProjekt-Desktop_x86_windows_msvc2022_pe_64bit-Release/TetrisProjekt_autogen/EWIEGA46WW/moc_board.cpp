...
Q_CONSTINIT static const qt_meta_stringdata_CLASSBoardENDCLASS_t qt_meta_stringdata_CLASSBoardENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 12),  // "boardUpdated"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 6),  // "koniec"
        QT_MOC_LITERAL(27, 11)   // "updateBoard"
    },
    "Board",
    "boardUpdated",
    "",
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->koniec(); break;
        case 2: _t->updateBoard(); break;
        default: ;
        }
        ...
        {
            using _t = void (Board::*)();
            if (_t _q_method = &Board::boardUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Board::*)();
            if (_t _q_method = &Board::koniec; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
