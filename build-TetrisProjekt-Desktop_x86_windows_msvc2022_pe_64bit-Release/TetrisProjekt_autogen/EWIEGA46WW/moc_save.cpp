...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSaveENDCLASS_t qt_meta_stringdata_CLASSSaveENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 15),  // "zapisaneClicked"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 9),  // "pokazMenu"
        QT_MOC_LITERAL(32, 20),  // "on_ZapiszBtn_clicked"
        QT_MOC_LITERAL(53, 8),  // "Wyswietl"
        QT_MOC_LITERAL(62, 18),  // "on_MenuBtn_clicked"
        QT_MOC_LITERAL(81, 21)   // "on_ZamknijBtn_clicked"
    },
    "Save",
    "zapisaneClicked",
    "",
...
void Save::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->zapisaneClicked(); break;
        case 1: _t->pokazMenu(); break;
        case 2: _t->on_ZapiszBtn_clicked(); break;
        case 3: _t->Wyswietl(); break;
        case 4: _t->on_MenuBtn_clicked(); break;
        case 5: _t->on_ZamknijBtn_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (Save::*)();
            if (_t _q_method = &Save::zapisaneClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Save::*)();
            if (_t _q_method = &Save::pokazMenu; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
